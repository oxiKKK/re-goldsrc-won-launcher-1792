...
// The WON block is unnumbered, so declaration order sets the values 0..14 --
// pinned by ES_ErrorTypeToString (0x40d0d0), which names every one of them.
// Do not reorder or insert: ES_SHUTDOWN must stay 14.
enum ES_ErrorType {
	ES_NO_ERROR,
	ES_ERROR_NO_TYPE,
	ES_INVALID_ADDR,
	...
	ES_PARTIAL_SENDTO,
	ES_TIMED_OUT,
	ES_ERROR_STREAM_NOT_ALLOWED,
	ES_SHUTDOWN,
	ES_UNKNOWN_ERROR,

	ES_UNEXPECTED_ENCRYPTED_MESSAGE,
	ES_SESSIONID_MISMATCH,
	ES_DECRYPT_FAILURE,
	ES_SEQUENCE_NUM_MISMATCH,
	ES_GET_PUB_KEY_FAILURE,
	ES_AUTH_INVALID_REPLY,
	ES_NEED_CERTIFICATE,
...
// ES_WSAENOTEMPTY = WSAENOTEMPTY, ES_WSAEPROCLIM = WSAEPROCLIM, ES_WSAEUSERS =
// WSAEUSERS, ES_WSAEDQUOT = WSAEDQUOT, ES_WSAESTALE = WSAESTALE, ES_WSAEREMOTE =
// WSAEREMOTE.
