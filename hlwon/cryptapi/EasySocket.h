...
//////////////////////////////////////////////////////////////////////////////
  ...
  Public Methods:
    ...
    ES_ErrorType connect(const std::string &theAddress, int thePort, int theWaitTime = 5000, int theNumTries = 1) // UDP/TCP
    ...
    ES_ErrorType sendBufferTo(const void *theBuf, int theLen, const std::string &theAddr, int thePort, int theTotalTime = 1000); // UDP/TCP
    ...
    ES_ErrorType recvBufferFrom(void *theBuf, int theLen, std::string *theAddrString, int *thePort, int *theRecvLen = NULL, int theTotalTime = 1000); // UDP/TCP
...
//////////////////////////////////////////////////////////////////////////////
  ...
  Accessors:
    ...
    std::string getDestAddrString(void); // UDP/TCP
    ...
    std::string getLocalAddrString(void); // UDP/TCP
...
//////////////////////////////////////////////////////////////////////////////
  ...
  Static Methods:
    ...
    static ES_ErrorType getSockAddrIn(SOCKADDR_IN &theSockAddr, const std::string &theAddress, int thePort) // UDP/TCP
      Converts an address std::string and port to a SOCKADDR_IN struct.

    static long getAddrFromString(const std::string &theAddress) // UDP/TCP
      Converts a std::string address to a long (in network byte order)

    static std::string getAddrFromLong(long theAddress) // UDP/TCP
          Converts a long address (in network byte order) to a std::string
*/
...
#  include <winsock.h>
# endif
// NOTE(ox): GoldSrc doesn't have this defined.
//# include <wsipx.h>
//# define HAVE_IPX
...
public:
    ...
    void getDestAddr(unsigned char theAddr[6]); // IPX/SPX
#endif // HAVE_IPX
    std::string getDestAddrString(void);
    int getDestPort(void);
    ...
    void getLocalAddr(unsigned char theAddr[6]); // IPX/SPX
#endif // HAVE_IPX
    std::string getLocalAddrString(void);
    int getLocalPort(void);
    ...
    static ES_ErrorType WSAErrorToEnum(int theError);
    static ES_ErrorType getSockAddrIn(SOCKADDR_IN &theSockAddr, const std::string &theAddress, int thePort); // UDP/TCP
    static ES_ErrorType getSockAddrIn(SOCKADDR_IN &theSockAddr, const std::string &theAddressAndPort); // UDP/TCP
#ifdef HAVE_IPX
    ...
    static ES_ErrorType getSockAddrInFast(SOCKADDR_IN &theSockAddr, const std::string &theAddress, int thePort); // UDP/TCP
    static ES_ErrorType getSockAddrInFast(SOCKADDR_IN &theSockAddr, const std::string &theAddressAndPort); // UDP/TCP
...
#ifdef HAVE_IPX
    static void getAddrFromString(unsigned char theAddr[6], const std::string &theAddress); // IPX/SPX
    static std::string getAddrFromNodeNum(unsigned const char theNodeNum[6]); // IPX/SPX
#endif // HAVE_IPX
};
...
// This class is used so that the user doesn't have to worry about initializing
// winsock or stopping winsock.
