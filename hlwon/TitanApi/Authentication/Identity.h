...
private:
	...
	// Block of state-data for async authentication request.  Public because
	// Identity.cpp declares a file-scope list of these; VC6 let that reach a
	// private nested class, a conformant compiler does not.
public:
