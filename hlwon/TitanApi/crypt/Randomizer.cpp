...
Randomizer::GenerateSeed()
{
	...
	WDBG_LM("Randomizer::GenerateSeed Initial Seed=" << static_cast<unsigned __int64>(aSeed));
	...
	*(reinterpret_cast<unsigned short*>(&aSeed)) = *(reinterpret_cast<unsigned short*>(&aSysTick) + 1);
	...
	// Seed the pool
	WDBG_LM("Randomizer::GenerateSeed Seed=" << static_cast<unsigned __int64>(aSeed));
