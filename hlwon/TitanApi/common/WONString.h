...
private:
	...
	void MakeTitanWide() const
	{
		MakeWide();
#ifdef WIN32
		titanwstr.assign(reinterpret_cast<const wchar*>(wstr.data()), wstr.size());
#else
	...
	int wstr_compare(size_t pos, size_t n, const wchar* s) const		{ return wstr.compare(pos, n, reinterpret_cast<const wchar_t*>(s)); }
	...
	int wstr_compare(const wchar* s, size_t pos, size_t n) const		{ return wstr.compare(0, static_cast<size_t>(-1), reinterpret_cast<const wchar_t*>(s), pos, n); }
	...
	int wstr_compare(size_t pos0, size_t n0, const wchar* s, size_t pos, size_t n) const			{ return wstr.compare(pos0, n0, reinterpret_cast<const wchar_t*>(s), pos, n); }
